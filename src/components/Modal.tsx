        ...
        <div className="border-slate-600 border  relative bg-[#374151]  text-white  rounded-lg shadow ">
          ...
          <div className="border-slate-600 border  p-6 space-y-6 grid grid-cols-3 gap-4">
            ...
            <div className="text-gray-300">
              ...
              <div className="flex text-gray-300">{currentUser?.gender}</div>
            </div>
            <div className="text-gray-300">
              <Label className="flex font-semibold mb-1 text-base font-Roboto text-white">
                Age:
              </Label>
              <div className="flex text-gray-300">{currentUser?.dob.age}</div>
            </div>
            <div className="text-gray-300">
              <Label className="flex font-semibold mb-1 text-base font-Roboto text-white">
                Email:
              </Label>
              <div className="flex text-gray-300">{currentUser?.email}</div>
            </div>
            <div className="text-gray-300">
              <Label className="flex font-semibold mb-1 text-base font-Roboto text-white">
                Username:
              </Label>
              <div className="text-gray-300">{currentUser?.login.username}</div>
            </div>
            <div className="text-gray-300">
              <Label className="flex font-semibold mb-1 text-base font-Roboto text-white">
                Cellphone:
              </Label>
              <div className="text-gray-300">{currentUser?.cell}</div>
            </div>
            <div className="text-gray-300">
              <Label className="flex font-semibold mb-1 text-base font-Roboto text-white">
                UserID:
              </Label>
              <div className="text-gray-300">{currentUser?.login.uuid}</div>
            </div>
            <div className="text-gray-300">
